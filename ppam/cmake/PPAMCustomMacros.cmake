...
macro(ppam_combine_archives target dependency)
    if(MSVC)
...
macro(ppam_fetch_thirdparty_content content_file)
    set(PPAM_FETCHCONTENT_BASE_DIR_OLD ${FETCHCONTENT_BASE_DIR})
    set(FETCHCONTENT_BASE_DIR ${PPAM_THIRDPARTY_DIR} CACHE STRING "" FORCE)
    include(${content_file})
    set(FETCHCONTENT_BASE_DIR ${PPAM_FETCHCONTENT_BASE_DIR_OLD} CACHE STRING "" FORCE)
    unset(PPAM_FETCHCONTENT_BASE_DIR_OLD)
endmacro()
