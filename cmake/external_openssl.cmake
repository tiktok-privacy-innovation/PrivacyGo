...
set(OPENSSL_SOURCES_DIR ${DPCA_PSI_THIRDPARTY_DIR}/openssl-src)
set(OPENSSL_INCLUDE_DIR "${OPENSSL_SOURCES_DIR}/include")
...
ExternalProject_Add(
  ...
  CONFIGURE_COMMAND ./config no-shared -fPIC --prefix=${OPENSSL_SOURCES_DIR} ${OPENSSL_ASM_OPTION}
  BUILD_COMMAND     make depend -j ${NUM_OF_PROCESSOR} && make -j ${NUM_OF_PROCESSOR}
  BUILD_IN_SOURCE   1
)

set(OPENSSL_CRYPTO_LIBRARY "${OPENSSL_SOURCES_DIR}/lib/libcrypto.a")
set(OPENSSL_SSL_LIBRARY "${OPENSSL_SOURCES_DIR}/lib/libssl.a")
