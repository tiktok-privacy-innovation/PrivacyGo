...
macro(mpc_dualdp_combine_archives target dependency)
    if(MSVC)
...
macro(mpc_dualdp_fetch_thirdparty_content content_file)
    set(MPC_DUALDP_FETCHCONTENT_BASE_DIR_OLD ${FETCHCONTENT_BASE_DIR})
    set(FETCHCONTENT_BASE_DIR ${MPC_DUALDP_THIRDPARTY_DIR} CACHE STRING "" FORCE)
    include(${content_file})
    set(FETCHCONTENT_BASE_DIR ${MPC_DUALDP_FETCHCONTENT_BASE_DIR_OLD} CACHE STRING "" FORCE)
    unset(MPC_DUALDP_FETCHCONTENT_BASE_DIR_OLD)
endmacro()
